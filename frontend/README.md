...
2. **Configurar variables de entorno:**
   ...
   _Nota: Solicita al administrador del repositorio los valores reales de los IDs de Google Auth y el Secret de NextAuth._
...
- **`AUTH_SECRET`**: Una cadena aleatoria que NextAuth exige para encriptar los JWT (JSON Web Tokens) de las sesiones de usuario.
- **`AUTH_GOOGLE_ID` y `AUTH_GOOGLE_SECRET`**: Credenciales otorgadas por Google Cloud Console para habilitar el login con Gmail en nuestra plataforma.
...
AUTH_SECRET=<generate_a_random_32+_character_secret>
