export default function HowToSection() {
  return (
    <section id="indicaciones" className="w-full px-6 py-[60px] bg-white">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-0 md:divide-x md:divide-border">
          ...
          <div className="flex flex-col gap-6 md:pr-10">
            <h3 className="w-full rounded-md bg-[hsl(var(--secondary))] px-6 py-3 text-sm md:text-base font-semibold text-white text-center">
              ¿Cómo puedo obtener el bot?
            </h3>
            <ul className="flex flex-col gap-4 text-sm md:text-base text-muted-foreground leading-relaxed list-disc list-inside">
              <li>
